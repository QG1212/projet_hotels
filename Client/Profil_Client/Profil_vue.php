...
<div class="container-form">
    ...
    <form id="profile-form" action="Profil.php" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="prenom" class="form-control" value="<?php echo $prenom ?>" required>
        </div>

        <!-- Nom -->
        <div class="mb-3">
            <label for="nom" class="form-label">Nom :</label>
            <input type="text" id="nom" class="form-control" value="<?php echo $client["nom"] ?>" required>
        </div>

        <!-- Email -->
        <div class="mb-3">
            <label for="email" class="form-label">Email :</label>
            <input type="email" id="email" class="form-control" value="<?php echo $client["email"] ?>" required>
        </div>

        <!-- Téléphone -->
        <div class="mb-3">
            <label for="tel" class="form-label">Numéro de téléphone :</label>
            <input type="tel" id="tel" class="form-control" value="<?php echo $client["tel"] ?>" pattern="^\+?[0-9]{10,15}$" required>
        </div>
